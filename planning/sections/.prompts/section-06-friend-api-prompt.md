...
Generate content for section `section-06-friend-api` (filename: `section-06-friend-api.md`).
...
for `section-06-friend-api` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-06-friend-api.md`
