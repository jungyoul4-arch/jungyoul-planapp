...
Generate content for section `section-07-nickname-sharing-api` (filename: `section-07-nickname-sharing-api.md`).
...
for `section-07-nickname-sharing-api` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-07-nickname-sharing-api.md`
