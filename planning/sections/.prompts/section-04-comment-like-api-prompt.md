...
Generate content for section `section-04-comment-like-api` (filename: `section-04-comment-like-api.md`).
...
for `section-04-comment-like-api` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-04-comment-like-api.md`
