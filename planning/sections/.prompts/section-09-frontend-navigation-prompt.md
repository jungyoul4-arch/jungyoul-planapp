...
Generate content for section `section-09-frontend-navigation` (filename: `section-09-frontend-navigation.md`).
...
for `section-09-frontend-navigation` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-09-frontend-navigation.md`
