...
Generate content for section `section-02-board-api` (filename: `section-02-board-api.md`).
...
for `section-02-board-api` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-02-board-api.md`
