...
Generate content for section `section-11-frontend-editor-photos` (filename: `section-11-frontend-editor-photos.md`).
...
for `section-11-frontend-editor-photos` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-11-frontend-editor-photos.md`
