...
Generate content for section `section-08-moderation-api` (filename: `section-08-moderation-api.md`).
...
for `section-08-moderation-api` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-08-moderation-api.md`
