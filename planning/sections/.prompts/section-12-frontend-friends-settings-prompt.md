...
Generate content for section `section-12-frontend-friends-settings` (filename: `section-12-frontend-friends-settings.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/jungyoulkwak/jungyoul-planapp/planning/claude-plan.md` - Full implementation plan
2. `/Users/jungyoulkwak/jungyoul-planapp/planning/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/jungyoulkwak/jungyoul-planapp/planning/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-12-frontend-friends-settings` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-12-frontend-friends-settings.md`
