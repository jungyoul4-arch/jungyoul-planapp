...
Generate content for section `section-10-frontend-board-posts` (filename: `section-10-frontend-board-posts.md`).
...
for `section-10-frontend-board-posts` to understand what this section should contain.
...
`/Users/jungyoulkwak/jungyoul-planapp/planning/sections/section-10-frontend-board-posts.md`
