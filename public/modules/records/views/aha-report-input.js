            ...
            <div class="aha-note-grid">
              ...
              ${notePhotos.length < 3 ? `
                <div class="pu-ref-add-tile" style="position:relative;cursor:pointer" onclick="this.querySelector('input').click()">
                  ...
                  <span>추가 촬영</span>
                  <input type="file" accept="image/*" multiple style="position:absolute;width:1px;height:1px;opacity:0;overflow:hidden" onchange="_RM.handleAhaNoteUpload(this)">
                </div>
              ` : ''}
            </div>
          ` : `
          ...
          <div class="pu-ref-grid">
            ...
            ${refPhotos.length < 5 ? `
              <div class="pu-ref-add-tile" style="position:relative;cursor:pointer" onclick="this.querySelector('input').click()">
                ...
                <input type="file" accept="image/*" multiple style="position:absolute;width:1px;height:1px;opacity:0;overflow:hidden" onchange="_RM.handleAhaRefUpload(this)">
              </div>
            ` : ''}
          </div>
